        ...
        <div className="text-center bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-gray-200">
          <div className="text-center mb-16 relative">
            <div className="absolute inset-0 flex items-center justify-center opacity-5">
              <LuQuote className="w-64 h-64 text-blue-500" />
            </div>
          ...
          <div className="relative max-w-5xl mx-auto mb-12">
            <div
              className="relative bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-200 border border-gray-300 overflow-hidden p-8 md:p-12"
            ...
            >
              ...
              <div className="relative z-10">
                <LuQuote className="w-12 h-12 text-blue-300 mb-6" />
            ...
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 -translate-x-full bg-white/90 hover:bg-white text-blue-600 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-110"
            >
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 translate-x-full bg-white/90 hover:bg-white text-blue-600 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-110"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {testimonials.slice(0, 3).map((testimonial, index) => (
              <div
                key={testimonial.id}
                className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-200 border border-gray-300 overflow-hidden p-6"
              >
